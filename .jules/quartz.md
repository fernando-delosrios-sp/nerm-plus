...
## 2024-06-16 - Simplify nullish checks
**Learning:** Verbose `!== undefined && !== null` checks combined with ternary fallbacks create visual noise and cognitive load.
**Action:** Use loose inequality (`!= null`) and the nullish coalescing operator (`??`) to dramatically reduce visual noise and simplify logic while correctly preserving falsy values.
