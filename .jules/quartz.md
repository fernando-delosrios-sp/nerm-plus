...
## 2024-05-28 - Write missing tests for newly identified models

**Learning:** Adding test files specific to un-tested data models ensures property mappings (e.g. status boolean transformations) perform correctly.
**Action:** Always identify when core data models lack sufficient test coverage and create tests that cover property mapping and edge cases.
